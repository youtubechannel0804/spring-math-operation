...
public class MathOperationControllerTest {
	...
	public void setup() throws JsonProcessingException {
		...
		MathVariable mathVariable = new MathVariable("100", "50");
	...
	public void testDiffAPI() throws Exception {
		...
		verifyResponse(response, "50");
	}

	public void verifyResponse(ResponseEntity<String> response, String value) {
